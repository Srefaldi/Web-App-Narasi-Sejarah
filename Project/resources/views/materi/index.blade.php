                        ...
                        <section id="services" class="services sections-bg">
                            <div class="container" data-aos="fade-up">
                                ...
                                <div class="section-header">
                                    <h2>Materi</h2>
                                    <p>Selamat datang di halaman materi website interaktif narasi sejarah tentang Kesultanan
                                        Banjar!</p>
                                    <p>Di sini, Anda akan memasuki perjalanan yang menarik ke masa lalu yang penuh dengan
                                        keajaiban sejarah dan budaya.</p>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('materi.store') }}" method="post"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="description">Deskripsi</label>
                                                        <textarea name="description" id="tambahdesc" class="form-control"></textarea>
                                                    </div>
