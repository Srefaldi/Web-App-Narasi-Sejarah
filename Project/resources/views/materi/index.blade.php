          ...
          <div class="container-fluid">
              ...
              <div class="row">
                  <div class="col-12">
                       @if (auth()->user()->level == 'admin')
                          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addItem">Tambah Materi</button><br><br>
                        @endif
              ...
              <div class="card border-0 mb-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0 text-secondary">{!! htmlspecialchars_decode(substr($item->description, 0, 100)) !!}</p><a href="{{ route('readmore.materi', ['id' => $item->id]) }}" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form action="{{ route('materi.update', $item->id) }}" method="post"
                          ...
                          <button class="btn btn-primary" type="submit">Edit Materi</button>
                      </form>
                  </div>
              </div>
            </div>
            </div>
            <script src="{{ asset('path/to/classic-editor.js') }}"></script> <!-- Pastikan Anda memuat dependensi ClassicEditor terlebih dahulu -->
            <script>
              ClassicEditor
